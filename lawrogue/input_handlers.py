...
if TYPE_CHECKING:
    ...
    from lawrogue.entity import Item
...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def ev_mousebuttondown(
        self, event: tcod.eventMouseButtonDown
    ) -> ActionOrHandler | None:
        """
...
class SelectIndexHandler(AskUserEventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> ActionOrHandler | None:
        ...
        key = event.sym
        if key in MOVE_KEYS:
            modifier = 1  # Holding modifier keys will spped up key movement.
...
class AreaRangedAttackHandler(SelectIndexHandler):
    ...
    Any entity within the given area will be affected.
    """
